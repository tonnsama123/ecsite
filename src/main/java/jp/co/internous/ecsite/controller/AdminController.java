...
import jp.co.internous.ecsite.model.MstGoods;
...
public class AdminController {
	...
	public String welcome(LoginForm form, Model model) {
		...
		public String goodsMst(GoodsForm goodsForm, LoginForm loginForm, Model m) {
		...
		public String deleteApi(@RequestBody GoodsForm f, Model m) {
			try {
				...
				return "-1";  //例外が起きたら処理に失敗として-1を返却
			}
			return "1";  //例外が起きずここまで到達したら成功として１
		}
